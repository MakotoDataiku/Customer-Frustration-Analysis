...
def get_table(params):
    ...
    df_sorted = df_sorted[["noun_lemmatized", "mean_polarity_textblob", "tb_importance"]].rename({"noun_lemmatized":"topics", "mean_polarity_textblob":"average scores", "tb_importance":"importance score"})
